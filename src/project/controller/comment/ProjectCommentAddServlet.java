...
/**
 * Servlet implementation class ProjectCommentAddServlet
 */
@WebServlet("/project/comment/add")
public class ProjectCommentAddServlet extends HttpServlet {
     ...
     */
    public ProjectCommentAddServlet() {
        super();
